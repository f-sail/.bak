...
nnoremap <silent><leader>p ipublic:<Esc>oprivate:<Esc>opublic:<Esc>oprivate:<Esc>kkk$

" 多行添加 /**/
nnoremap <leader>kc :<C-u>call AddComment()<CR>
    function! AddComment()
        " 获取用户输入的行号范围
...
" 多行删除 /**/
nnoremap <leader>ku :<C-u>call DeleteComment()<CR>
